# FIPs 
Filecash Improvement Proposals (FIPs) describe standards for the Filecash platform, including core protocol specifications, client APIs, and other changes to the project.
...
# Contributing
 ...
 4. Submit a Pull Request to Filecash's [FIPs repository](https://github.com/filecash/CIPs).
 5. Draft and submit a Pull Request to the [Filecash Specification repository](https://github.com/filecoin-project/specs) to update the spec with the changes that your FIP brings.
...
When you believe your FIP is mature and ready to progress past the draft phase, you should do one of two things:
 ...
 - **For a Standards Track FIP of type Core**:
 	...
 	- prepare the changes to the spec text necessary to describe the protocol modifications that your FIP brings. Submit a PR to the [Filecash Specification repository](https://github.com/filecoin-project/specs). These changes will also be discussed in the "All Core Devs" meeting and the editor will assign a reviewer.
...
TODO: 
The canonical URL for a FIP that has achieved draft status at any point will be on the Filecash website. For example, the canonical URL for FIP-00001 will be https://filecoin.io/TODO.
